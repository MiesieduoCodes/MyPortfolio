...
const Experience = () => {
  return (
    ...
    <motion.h2
                ...
                initial="initial"
                animate="animate"
    className="my-20 text-center text-5xl">Exper  
        <span className="text-neutral-500">iences</span></motion.h2>
        <div className=" ">
        ...
        <div key={index} className="flex flex-wrap lg:justify-center">
            ...
            <div className="flex items-center justify-center">
                ...
                <div  className="w-full lg:w-1/4">
                    ...
                    <img src={experience.image} className="mb-10 rounded" width={200} height={150}  alt={experience.title} />
                    </a>
                </div>
